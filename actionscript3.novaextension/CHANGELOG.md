...
- Renamed menu options "Install SDK" to "Add SDK" and "Remove SDK" to "Forget SDK" since we don't add or delete those files
- Renamed "Installed SDKs" to "Known SDKs" in the extension settings
...
- Launch and Debug on device via USB for Android and iOS
...
- Android and iOS device simulator lists are stored in a JSON file (so eventually we can modify it)
- Updated NS3X2J to match Ant extension's code base
